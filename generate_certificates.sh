...
openssl req -new -x509 -days 3650 -extensions v3_ca -keyout "$SERVER_CERT_DIR/ca.key" -out "$SERVER_CERT_DIR/ca.crt" -subj "/CN=MyCA/OU=MyOrganization/C=US" -addext $SAN
